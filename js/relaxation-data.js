...
(function (global) {
  ...
  const TIPS_CONTENT = {
    ...
    rewardProcess: {
      ...
      points: [
        "Recommended treats: boiled, slivered chicken or tiny pieces of cheese. Boiled, shredded chicken can be frozen in small portions and defrosted as needed.",
        "Dog biscuits generally are not sufficient motivation, but some foods are so desirable that the dog is too stimulated by them to relax - something between these two extremes is preferred",
    ...
    exampleSequence: {
      ...
      points: [
        "Susie—sit—(3- to 5-second pause)—sit—good girl!—stay—(start to give treat and dog gets up)—no (whispered)—(close hand over treat)—sit—stay—(3- to 5-second pause)—s-t-a-y (long, low sound; no shouting)—good girl!—s-t-a-y (long, low sound; no shouting)—(and give treat)—okay! (dog is now allowed to get up)",
      ],
    },
  };
